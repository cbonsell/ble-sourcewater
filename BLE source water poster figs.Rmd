...
###To find out, we used salinity and $\delta ^{18}O$ of lagoon waters sampled in April (full sea ice cover), June (sea ice break-up), and August (open water summer) to determine the relative contribution of sea ice melt (SIM), marine Polar Mixed Layer (PML), and meteoric water (MW) to these dynamic lagoons. Each of these endmembers has distinct salinity and $\delta ^{18}O$ values. 
